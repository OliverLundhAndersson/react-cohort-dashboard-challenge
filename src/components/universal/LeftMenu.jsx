...
export default function LeftMenu() {
    ...
    return (
        <div className="left-menu" style={{ padding: '10px' }}>
            <Link to="/" className={`left-menu-item ${location.pathname === '/' ? 'selected' : ''}`} style={{ textDecoration: 'none' }}>
                ...
                <span className="left-menu-text">Home</span>
            </Link>

            <Link to={`/profile/${user.id}`} className={`left-menu-item ${location.pathname === '/profile/:contactId' ? 'selected' : ''}`} style={{ textDecoration: 'none' }}>
                ...
                <span className="left-menu-text">Profile</span>
            </Link>
        </div>
    )
}
